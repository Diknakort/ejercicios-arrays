...
//// FILTRO
function filtroLetra(element: any, index: any, array: any) {
    //let letraValor = "I";
...
function mayorDos(element: string, index: any, array: any): boolean {
...
// Reverse
function palindromo(element: any, index: any, array: any) {
